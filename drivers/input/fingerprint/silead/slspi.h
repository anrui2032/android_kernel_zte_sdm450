...
#define SL_INPUT_SCLICK_KEY KEY_HOME
#define SL_INPUT_LPRESS_KEY KEY_MENU
#define SL_INPUT_DCLICK_KEY KEY_HOME
#define SL_INPUT_UP_KEY     252
#define SL_INPUT_DOWN_KEY   251
