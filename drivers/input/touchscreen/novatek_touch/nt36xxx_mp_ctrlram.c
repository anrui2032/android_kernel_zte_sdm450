...
static void nvt_print_lmt_array(int32_t *array, int32_t x_ch, int32_t y_ch)
{
	...
	for (j = 0; j < y_ch; j++) {
		for (i = 0; i < x_ch; i++)
			pr_notice("%5d, ", array[j * x_ch + i]);
		pr_notice("\n");
	}
#if TOUCH_KEY_NUM > 0
	for (k = 0; k < Key_Channel; k++)
		pr_notice("%5d, ", array[y_ch * x_ch + k]);
...
static void nvt_print_criteria(void)
{
	...
	if (ts->carrier_system) {
		pr_notice("PS_Config_Lmt_Short_Diff_P: %5d\n", PS_Config_Lmt_Short_Diff_P);
		pr_notice("PS_Config_Lmt_Short_Diff_N: %5d\n", PS_Config_Lmt_Short_Diff_N);
#if TOUCH_KEY_NUM > 0
		pr_notice("PS_Config_Lmt_Key_Short_Diff_P: %5d\n", PS_Config_Lmt_Key_Short_Diff_P);
		pr_notice("PS_Config_Lmt_Key_Short_Diff_N: %5d\n", PS_Config_Lmt_Key_Short_Diff_N);
#endif /* #if TOUCH_KEY_NUM > 0 */
		pr_notice("PS_Config_Lmt_Short_Base_P: %5d\n", PS_Config_Lmt_Short_Base_P);
		pr_notice("PS_Config_Lmt_Short_Base_N: %5d\n", PS_Config_Lmt_Short_Base_N);
#if TOUCH_KEY_NUM > 0
		pr_notice("PS_Config_Lmt_Key_Short_Base_P: %5d\n", PS_Config_Lmt_Key_Short_Base_P);
		pr_notice("PS_Config_Lmt_Key_Short_Base_N: %5d\n", PS_Config_Lmt_Key_Short_Base_N);
#endif /* #if TOUCH_KEY_NUM > 0 */
	} else {
		pr_notice("PS_Config_Lmt_Short_Rawdata_P: %5d\n", PS_Config_Lmt_Short_Rawdata_P);
		pr_notice("PS_Config_Lmt_Short_Rawdata_N: %5d\n", PS_Config_Lmt_Short_Rawdata_N);
#if TOUCH_KEY_NUM > 0
		pr_notice("PS_Config_Lmt_Key_Short_Rawdata_P: %5d\n", PS_Config_Lmt_Key_Short_Rawdata_P);
		pr_notice("PS_Config_Lmt_Key_Short_Rawdata_N: %5d\n", PS_Config_Lmt_Key_Short_Rawdata_N);
#endif /* #if TOUCH_KEY_NUM > 0 */
	}
	...
	if (ts->carrier_system) {
		pr_notice("PS_Config_Lmt_FW_CC_I_P: %5d\n", PS_Config_Lmt_FW_CC_I_P);
		pr_notice("PS_Config_Lmt_FW_CC_I_N: %5d\n", PS_Config_Lmt_FW_CC_I_N);
#if TOUCH_KEY_NUM > 0
		pr_notice("PS_Config_Lmt_Key_FW_CC_I_P: %5d\n", PS_Config_Lmt_Key_FW_CC_I_P);
		pr_notice("PS_Config_Lmt_Key_FW_CC_I_N: %5d\n", PS_Config_Lmt_Key_FW_CC_I_N);
#endif /* #if TOUCH_KEY_NUM > 0 */
		pr_notice("PS_Config_Lmt_FW_CC_Q_P: %5d\n", PS_Config_Lmt_FW_CC_Q_P);
		pr_notice("PS_Config_Lmt_FW_CC_Q_N: %5d\n", PS_Config_Lmt_FW_CC_Q_N);
#if TOUCH_KEY_NUM > 0
		pr_notice("PS_Config_Lmt_Key_FW_CC_Q_P: %5d\n", PS_Config_Lmt_Key_FW_CC_Q_P);
		pr_notice("PS_Config_Lmt_Key_FW_CC_Q_N: %5d\n", PS_Config_Lmt_Key_FW_CC_Q_N);
#endif /* #if TOUCH_KEY_NUM > 0 */
	} else {
		pr_notice("PS_Config_Lmt_FW_CC_P: %5d\n", PS_Config_Lmt_FW_CC_P);
		pr_notice("PS_Config_Lmt_FW_CC_N: %5d\n", PS_Config_Lmt_FW_CC_N);
#if TOUCH_KEY_NUM > 0
		pr_notice("PS_Config_Lmt_Key_FW_CC_P: %5d\n", PS_Config_Lmt_Key_FW_CC_P);
		pr_notice("PS_Config_Lmt_Key_FW_CC_N: %5d\n", PS_Config_Lmt_Key_FW_CC_N);
#endif /* #if TOUCH_KEY_NUM > 0 */
	}

	pr_notice("PS_Config_Lmt_FW_Diff_P: %5d\n", PS_Config_Lmt_FW_Diff_P);
	pr_notice("PS_Config_Lmt_FW_Diff_N: %5d\n", PS_Config_Lmt_FW_Diff_N);
#if TOUCH_KEY_NUM > 0
	pr_notice("PS_Config_Lmt_Key_FW_Diff_P: %5d\n", PS_Config_Lmt_Key_FW_Diff_P);
	pr_notice("PS_Config_Lmt_Key_FW_Diff_N: %5d\n", PS_Config_Lmt_Key_FW_Diff_N);
#endif /* #if TOUCH_KEY_NUM > 0 */
	...
	uint8_t y_ch, const char *file_path, uint32_t offset)
{
	...
	for (y = 0; y < y_ch; y++) {
		for (x = 0; x < x_ch; x++) {
			...
			pr_notice("%5d, ", rawdata[iArrayIndex]);
...
*******************************************************/
static int32_t RawDataTest_Sub(int32_t rawdata[], uint8_t RecordResult[], uint8_t x_ch,
...
static int32_t nvt_selftest_open(struct inode *inode, struct file *file)
{
	...
	if (nvt_read_CC(RawData_FW_CC) != 0) {
		...
		if (ts->carrier_system) {
			TestResult_FW_CC_I = RawDataTest_Sub(RawData_FW_CC_I,
			...
			TestResult_FW_CC_Q = RawDataTest_Sub(RawData_FW_CC_Q,
			...
			TestResult_FW_CC = RawDataTest_Sub(RawData_FW_CC,
	...
	if (nvt_read_fw_noise(RawData_Diff) != 0) {
		...
		TestResult_FW_DiffMax = RawDataTest_Sub(RawData_Diff_Max,
		...
		if (ts->carrier_system)
			...
			TestResult_FW_DiffMin = RawDataTest_Sub(RawData_Diff_Min,
	...
	if (nvt_read_fw_short(RawData_Short) != 0) {
		...
		if (ts->carrier_system) {
			TestResult_Short_Diff = RawDataTest_Sub(RawData_Short_Diff,
			...
			TestResult_Short_Base = RawDataTest_Sub(RawData_Short_Base,
			...
			TestResult_Short = RawDataTest_Sub(RawData_Short,
...
#if NVT_DEBUG
		pr_notice("[NVT-ts] %s = ", name);
		for (i = 0; i < len; i++)
			pr_notice("%02d ", array[i]);
