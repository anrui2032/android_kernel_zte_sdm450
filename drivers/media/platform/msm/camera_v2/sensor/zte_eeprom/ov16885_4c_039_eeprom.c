...
static struct zfg_eeprom_fn_t ov16885_4c_eeprom_func_tbl = {
...
static const struct of_device_id ov16885_4c_eeprom_dt_match[] = {
	{ .compatible = "zfg,ov16885_4c_039-eeprom", .data = &ov16885_4c_eeprom_func_tbl},
};
...
static struct platform_driver ov16885_4c_eeprom_platform_driver = {
	.driver = {
		.name = "zfg,ov16885_4c_039-eeprom",
		.owner = THIS_MODULE,
