...
static struct zfg_eeprom_fn_t ov16b10_031_eeprom_func_tbl = {
...
static const struct of_device_id ov16b10_031_eeprom_dt_match[] = {
	{ .compatible = "zfg,ov16b10_031-eeprom", .data = &ov16b10_031_eeprom_func_tbl},
};
